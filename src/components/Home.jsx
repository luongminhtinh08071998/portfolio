...
import { BiLogoFacebookCircle, BiLogoGithub, BiLogoInstagram, BiMouse } from "react-icons/bi";
...
const Home = () => {
  useEffect(() => {
    ...
    if (app) {
      ...
      typewriter.typeString('Guitarist')
        .pauseFor(2000)
        .deleteAll()
    ...
    <section className="home section" id="home">
      <div className="home__container container grid">
        ...
        <div className="home__social">
          <a target="_blank" href="https://www.facebook.com/luongminhtinh08071998/" className="home__social-link">
            <BiLogoFacebookCircle />
          </a>
          <a target="_blank" href="https://github.com/luongminhtinh08071998" className="home__social-link">
            <BiLogoGithub />
          </a>
